...
class ListProduct extends React.Component {
    ...
    searchProduct =()=>{
        ...
        fetch("http://localhost:8089/api/product/getProduct/"+pdtName, { 
             method: "GET",
             headers: headersList
         }).then((res) => res.json())
           .then((json) => {
	...
	componentDidMount() {
        ...
        fetch("http://localhost:8089/api/product/getProduct/*", { 
             method: "GET",
             headers: headersList
         }).then((res) => res.json())
           .then((json) => {
            ...
            <div class="row" >
            {
               ...
               <div className="thumbnail">
                    ...
                    <div style={{width:"10px" , height:"110px"}}>
                        ...
                        <p>  
                        <Link to="/setPdt" params={{testValue: "hello" }} className="btn">Buy</Link>
                        </p>
                    </div>
             </div>
            </div>)
